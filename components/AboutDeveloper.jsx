  ...
  <section id="developer" className="py-10 sm:py-14 bg-[var(--color-bg-muted)] border-b border-gray-100">
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="text-center mb-10" data-aos="fade-up">
        ...
        }}>Runwal Realty — Developer Profile</span>
        <h2 style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px' }}>
              Runwal Raaya is a landmark ultra-luxury development set across 4 acres in the heart of Worli, Mumbai. With a legacy of delivering high-quality homes, Runwal Realty continues to redefine premium living through iconic twin-tower design, curated craftsmanship, and an unwavering commitment to quality and elegance.</p>


            {/* Stats */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '22px' }}>
              {[
                { value: '4', label: 'Acres — Worli, Mumbai' },
                { value: '2', label: 'Iconic Towers' },
                { value: 'Dec\'30', label: 'Possession Date' },
              ].map((stat, i) => (
                <div key={i} style={{
