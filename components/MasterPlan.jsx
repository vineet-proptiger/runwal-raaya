...
const plans = [
  ...
  { label: '3 BHK — 1,738 sq.ft onwards*',          img: masterplanImages.bhk3 },
  { label: '4 BHK — 2,208 sq.ft onwards*',          img: masterplanImages.bhk45 },
  { label: '5 BHK — 4,285 sq.ft onwards*',          img: masterplanImages.bhk2 },
]
    ...
    <section id="masterplan" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          }}>Worli, Mumbai — Layout & Configuration</span>
          <h2 style={{
