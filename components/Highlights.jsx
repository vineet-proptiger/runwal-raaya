...
const highlights = [
  {
    text: '2-Acre Podium Garden at Your Feet',
    icon: <Trees {...highlightIconProps} />,
  },
  {
    text: 'Private Elevators in Each Residences',
    icon: <HeartPulse {...highlightIconProps} />,
  },
  {
    text: 'Natural Waterscapes & Lap Pool',
    icon: <Waves {...highlightIconProps} />,
  },
  {
    text: 'Sunlit Terraces & Open Sky Decks',
    icon: <Trophy {...highlightIconProps} />,
  },
  {
    text: 'Signature Water Features',
    icon: <Waves {...highlightIconProps} />,
  },
  {
    text: 'Premium Fitness & Wellness Facilities',
    icon: <Dumbbell {...highlightIconProps} />,
  },
  {
    text: 'Iconic Twin Tower Design — Worli',
    icon: <BookOpen {...highlightIconProps} />,
  },
  {
    text: 'Hotel-style Air-conditioned Lobbies',
  ...
  <section id="highlights" style={{
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        ...
        }}>Worli, Mumbai — Project Excellence</span>
        <h2 style={{
          fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
          color: '#111827', margin: 0, letterSpacing: '-0.01em',
        }}>
          Highlights Gallery:{' '}
          <span style={{ color: 'var(--color-gold)' }}>Runwal Raaya</span>
        </h2>
