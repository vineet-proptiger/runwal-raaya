...
const OPEN_VIEWS = [
  ...
  { dir: '23m', label: 'T3 Airport', sub: 'Via UER-II Tunnel' },
  { dir: 'CBD', label: 'Global City', sub: '1000+ Acres Beside' },
  { dir: 'MNC', label: 'TCS & Amex', sub: '5 Mins Away' },
  { dir: '10m', label: 'Schools & Hospitals', sub: 'Within 10 Mins' },
]
    ...
    <section id="overview" className="!pt-1 !pb-4 sm:!py-10" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          }}>Worli, Mumbai — New Launch</span>
          <h2 style={{
            fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
            color: '#111827', margin: 0, letterSpacing: '-0.01em',
          }}>
            Runwal Raaya <span style={{ color: 'var(--color-gold)' }}>Overview</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            <div style={{
              ...
              <Image src={overviewImage} alt="Runwal Raaya" fill className="object-cover"
